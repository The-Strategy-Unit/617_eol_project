...
ggplot() +
  # stp male
  geom_density(data = filter(mpi, sex == "male"),
               aes(age, -..density..),
               colour = su_theme_cols("dark_blue")[[1]],
               fill = su_theme_cols("light_blue")[[1]]) +
  # region male
  geom_density(data = filter(mpi_region, sex == "male"),
               aes(age, -..density..),
               linetype = "dotted") +
  # stp female
  geom_density(data = filter(mpi, sex == "female"),
               aes(age,  ..density..),
               colour = su_theme_cols("dark_red")[[1]],
               fill = su_theme_cols("light_red")[[1]]) +
  # region female
  geom_density(data = filter(mpi_region, sex == "female"),
               aes(age,  ..density..),
               linetype = "dotted") +
  coord_flip() +
